...
public class ly2Activity extends AppCompatActivity {
    ...
    public void insert(View view){
        ...
        try{
            ...
            Log.e(ly2Activity.class.toString(),e.toString());
    ...
    public void show(View view){
        ...
        try{
            ...
            while (cursor.moveToNext()){
                ...
                Log.i(ly2Activity.class.toString(),"id:"+id+",name:"+name+",age:"+age+",height:"+height);
