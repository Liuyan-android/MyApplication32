...
public class ly3Activity extends AppCompatActivity {
                ...
                cameraCaptureSession.capture(builder.build(), new CameraCaptureSession.CaptureCallback() {
                    ...
                    public void onCaptureCompleted(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, @NonNull TotalCaptureResult result) {
                        ...
                        try {
                            ...
                            Log.e(ly3Activity.class.toString(),e.toString());
                        }
                    }
                },null);
            }catch (Exception e){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stateCallback = new CameraDevice.StateCallback() {
            ...
            public void onOpened(@NonNull CameraDevice cameraDevice) {
                ...
                ly3Activity.this.cameraDevice = cameraDevice;
                //准备预览时使用的组件
                ...
                try {
                    ...
                    imageReader.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() {
                        ...
                        public void onImageAvailable(ImageReader imageReader) {
                            ...
                            int permission = ActivityCompat.checkSelfPermission(ly3Activity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);

                            if (permission != PackageManager.PERMISSION_GRANTED) {
// We don't have permission so prompt the user
                                ActivityCompat.requestPermissions(ly3Activity.this, PERMISSIONS_STORAGE, REQUEST_EXTERNAL_STORAGE);
                            }
                            ...
                            try{
                                ...
                                Toast.makeText(ly3Activity.this,"save:"+file,Toast.LENGTH_LONG).show();
                            }catch (Exception e){
                                Log.e(ly3Activity.class.toString(), e.toString());
                            }finally {
                                try{
                                    ...
                                    Log.e(ly3Activity.class.toString(), ee.toString()) ;
                                }
                            }
                    ...
                    cameraDevice.createCaptureSession(Arrays.asList(surface,imageReader.getSurface()), new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            ...
                            //开始显示相机的预览
                            ly3Activity.this.cameraCaptureSession = cameraCaptureSession;
                            try {
            ...
            public void onDisconnected(@NonNull CameraDevice cameraDevice) {
                ly3Activity.this.cameraDevice=null;
            }
    ...
    private void setCameraLayout(){
        ...
        textureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() {
            ...
            public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
                ...
                ly3Activity.this.surfaceTexture=surfaceTexture;
